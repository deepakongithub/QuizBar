...
<body>
	...
	<div class="main-w3layouts wrapper">
		<h1>SignUp To QuizBar</h1>
		<div class="main-agileinfo">
			<div class="agileits-top">
				<form:form action="signup" method="post" modelAttribute = "register">
					...
					<input class="text w3lpass" type="password" name="password"	placeholder="Confirm Password" required="true">
					<div class="wthree-text">
						<label class="anim"> <input type="checkbox"	class="checkbox" required=""> <span>I Agree To The
